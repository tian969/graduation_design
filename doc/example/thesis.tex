...
\usepackage{tcolorbox}  % 对话气泡框
\usepackage{enumitem}   % 列表样式
\usepackage{pdfpages}
\usepackage{longtable}
% 将学位类型选中标记从“涂黑方框”改为“方框+打钩”。
\renewcommand{\blacksquare}{\makebox[0pt][l]{\raisebox{0.15ex}{\hspace{0.1em}$\checkmark$}}\Box}
% --- 对话气泡样式 ---
\newtcolorbox{UserBox}{
  colback=blue!3,
...
\pkuthssinfo{
	...
	ctitle = {面向多模态理解的对话安全模型构建与应用},
	etitle = {Construction and Application of a Dialogue Safety Model for Multimodal Understanding},
	cauthor = {田祖杰}, eauthor = {Zujie Tian}, date = {二〇二六~年~四~月},
	studentid = {2301210407}, school = {软件与微电子学院},
	cmajor = {软件工程}, emajor = {Software Engineering},
	direction = {软件工程}, mentorlines = {2},
	cmentor = {王平~~教授},
	cassistantmentor = {李文婷~~讲师},
	ementor = {Prof.\ Ping Wang and Lec.\ Wenting Li},
	ckeywords = {大语言模型，内容安全},
	ekeywords = {LLM, Content Safety},
